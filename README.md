...
---
### 🚀 Deploying the Data Application with Kustomize
 ...
 * ***The kubectl apply -k command runs Kustomize directly, reading the kustomization.yaml file at the specified path to deploy all defined resources (PostgreSQL and Longhorn).***
---
